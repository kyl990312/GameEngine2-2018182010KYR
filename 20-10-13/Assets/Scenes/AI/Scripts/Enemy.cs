...
namespace Scenes.AI
{
    ...
    public class Enemy : MonoBehaviour, IDamagable
    {
        ...
        private DefaultCanvasUi _defaultCanvas;
        ...
        private void OnEnable()
        {
            ...
            // create health bar
            var go = ObjectPoolManager.Instance.Spawn("enemy_health_bar");
            var enemyHealthBar = go.GetComponent<EnemyHealthBar>();
            
            _defaultCanvas = FindObjectOfType<DefaultCanvasUi>();
            
            enemyHealthBar.Initialize(this,_defaultCanvas.GetComponent<Canvas>(),new Vector2(0,30));
            enemyHealthBar.transform.parent = _defaultCanvas.transform;
